...
class ShoppingListVC: UIViewController, ShoppingListDelegate {
    ...
    @IBAction func limpaLista(_ sender: UIBarButtonItem) {
        self.displayConfirmationAlert(title: "Are you sure?", message: "Are you sure that you want to delete your shopping list? There is no comming back", confirmTitle: "Ok", cancelTitle: "Cancel") { (action) in
